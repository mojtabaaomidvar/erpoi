      ...
      <div className="flex items-center gap-3 flex-1 min-w-0">
        <button
          ...
          className={`flex h-9 w-9 items-center justify-center rounded-lg border transition-all hover:scale-105 active:scale-95 shrink-0 ${
            isDark
              ? "border-slate-700 bg-slate-800 text-slate-300 hover:bg-slate-700 hover:text-white shadow-md shadow-black/20"
              : "border-slate-200 bg-white text-slate-600 hover:bg-slate-100 hover:text-indigo-600 shadow-md shadow-slate-200/50"
          }`}
        ...
        <div className="relative theme-menu-container">
          <button
            ...
            className={`flex h-9 w-9 items-center justify-center rounded-lg border transition-all hover:scale-110 active:scale-95 ${
              isDark
                ? "border-slate-700 bg-slate-800 text-amber-400 hover:bg-slate-700 shadow-md shadow-black/20"
                : "border-slate-200 bg-white text-slate-600 hover:bg-slate-100 shadow-md shadow-slate-200/50"
            }`}
