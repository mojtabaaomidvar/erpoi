...
import type { Client } from "@features/client-management/domain";
...
export const clients: Client[] = [
  {
    ...
    contactPersons: [
      ...
      },
      {
        ...
        position: "HSE Lead",
        mobile: "09124445566",
        email: "s.mohammadi@totalpars.com",
        department: "oi",
      },
      {
        id: "cp3",
        ...
        mobile: "09127778899",
        email: "r.hosseini@totalpars.com",
        department: "it",
      },
      {
        id: "cp4",
    ...
    contactPersons: [
      {
        ...
        mobile: "09123334455",
        email: "a.hosseini@kianinfra.com",
        department: "oi",
      },
      {
        id: "cp13",
    ...
    contactPersons: [
      {
        ...
        position: "CEO",
        mobile: "09125551122",
        email: "n.shahidi@zagrosenergy.com",
        department: "oi",
      },
      {
        id: "cp22",
        ...
        position: "Project Manager",
        mobile: "09126662233",
        email: "r.nikzad@zagrosenergy.com",
        department: "oi",
      },
    ],
  },
    ...
    contactPersons: [
      {
        ...
        mobile: "09127773344",
        email: "o.ghasemi@caspianmarine.ir",
        department: "oi",
      },
      {
        id: "cp24",
        ...
        mobile: "09128884455",
        email: "s.vahedi@caspianmarine.ir",
        department: "it",
      },
      {
        id: "cp25",
        ...
        mobile: "09129995566",
        email: "b.safari@caspianmarine.ir",
        department: "oi",
      },
    ],
  },
...
export const contractTariffs: TariffLine[] = [
  // ct1 - TotalEnergies Pars - South Pars Phase 22 (ACTIVE, invoiced ~40% of total)
  {
    id: "t1",
    contract_id: "ct1",
    description: "Senior Inspector Man-Day",
    unit: "MAN_DAY",
    rate: 850,
    total_quantity: 200,
  ...
  },
  {
    id: "t2",
    contract_id: "ct1",
    description: "Junior Inspector Man-Day",
    unit: "MAN_DAY",
    rate: 520,
    total_quantity: 150,
  ...
  },
  {
    id: "t3",
    contract_id: "ct1",
    description: "Document Review — Standard",
    unit: "DOCUMENT",
    rate: 180,
    total_quantity: 50,
  ...
  // ct2 - Mapna Group - Damavand MWS (ACTIVE, invoiced ~75%)
  {
    id: "t5",
    contract_id: "ct2",
    description: "Marine Warranty Surveyor",
    unit: "MAN_DAY",
    rate: 950,
    total_quantity: 100,
    consumed_quantity: 78,
    invoiced: 66500,
  },
  {
    id: "t6",
    contract_id: "ct2",
    description: "Load Test Witness",
    unit: "TRIP",
    rate: 2200,
    total_quantity: 15,
  ...
  // ct4 - Sunair Renewables - Kavir Solar (ACTIVE, invoiced ~20%)
  {
    id: "t10",
    contract_id: "ct4",
    description: "Solar Module Inspector",
    unit: "MAN_DAY",
    rate: 650,
    total_quantity: 80,
  ...
  // ct5 - Kian Infra - Tehran Metro (PENDING, invoiced = 0)
  {
    id: "t14",
    contract_id: "ct5",
    description: "Structural Inspector",
    unit: "MAN_DAY",
    rate: 750,
    total_quantity: 120,
    consumed_quantity: 0,
  ...
  },
  {
    id: "t21",
    contract_id: "ct6",
    description: "Scaffold Inspector",
    unit: "MAN_DAY",
    rate: 650,
    total_quantity: 40,
  ...
  // ct8 - IOOC - Forouzan Platform (PENDING)
  {
    id: "t30",
    contract_id: "ct8",
    description: "Turbine Specialist",
    unit: "MAN_DAY",
    rate: 1200,
    total_quantity: 50,
    consumed_quantity: 0,
  ...
  },
  {
    id: "t31",
    contract_id: "ct8",
    description: "Mechanical Inspector",
    unit: "MAN_DAY",
    rate: 850,
    total_quantity: 80,
    consumed_quantity: 0,
  ...
  // ct9 - Mapna - Turbine Overhaul WO (PENDING)
  {
    id: "t35",
    contract_id: "ct9",
    description: "Platform Inspector",
    unit: "MAN_DAY",
    rate: 1100,
    total_quantity: 100,
    consumed_quantity: 0,
  ...
  },
  {
    id: "t36",
    contract_id: "ct9",
    description: "Corrosion Specialist",
    unit: "MAN_DAY",
    rate: 1300,
    total_quantity: 60,
    consumed_quantity: 0,
  ...
  // ct10 - Arash Mohammadi Freelance (CLOSED)
  {
    id: "t43",
    contract_id: "ct10",
    description: "Freelance Inspection",
    unit: "LUMP_SUM",
    rate: 8500,
    total_quantity: 1,
    consumed_quantity: 1,
  ...
  // ct11 - Zagros Energy - Ahvaz Gas Turbine (ACTIVE)
  {
    id: "t44",
    contract_id: "ct11",
    description: "Power Plant Auditor",
    unit: "MAN_DAY",
    rate: 1000,
    total_quantity: 100,
