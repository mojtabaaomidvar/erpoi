...
import type { Contract, TariffLine, Adjustment, ContractModification, Guarantee, ContractAttachment } from '../../../types/contract';
                ...
                <div className={`rounded-lg border p-4 ${
                  ...
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <button
                      ...
                      className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                        formData.guarantee.has_guarantee ? 'bg-emerald-600' : (isDark ? 'bg-slate-700' : 'bg-slate-300')
                      }`}
                    >
                      <span className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        ...
                        <input
                          type="text"
                          inputMode="decimal"
                          value={formData.guarantee.percentage ? formatNumberInput(String(formData.guarantee.percentage)) : ''}
                          onChange={(e) => setFormData({
                            ...formData,
                            guarantee: { ...formData.guarantee, percentage: parseNumberInput(e.target.value) }
                          })}
                          className="w-full rounded-lg border px-3 py-2 text-sm font-mono text-right input-themed"
                          placeholder="0.00"
                        />
