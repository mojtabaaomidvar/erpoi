            ...
            <div>
              ...
              <div className="space-y-1">
                {diff.added.map((item: any, idx: number) => (
                  <div
                    key={idx}
                    className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded p-2"
                  >
  ...
  return (
    <div className="bg-white dark:bg-slate-800 rounded-lg p-3 border border-slate-200 dark:border-slate-700">
      ...
      <div className="grid grid-cols-2 gap-3">
        <div>
          <div className="text-xs text-red-600 dark:text-red-400 font-semibold mb-1.5">
            ❌ Before
          </div>
        ...
        <div>
          <div className="text-xs text-green-600 dark:text-green-400 font-semibold mb-1.5">
            ✅ After
          </div>
...
export function AuditLogDetailModal({ log, onClose }: Props) {
  const payload = (log as any).payload || log.new_value;
  ...
  return (
    ...
    >
      <div
        className={`bg-white dark:bg-slate-800 rounded-lg shadow-2xl max-w-5xl w-full max-h-[90vh] overflow-hidden border-t-4 ${levelBorderColors[log.level || "info"]}`}
                  ...
                  <div className="space-y-4">
                    {payload.updated.map((change: any, idx: number) => {
                      ...
                      return (
                        <div
                          key={idx}
                          className="bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-lg overflow-hidden"
                        >
