// src/views/clients/components/ClientForm.tsx
...
export function ClientForm({
  ...
  const handleSave = () => {
    ...
    if (duplicateWarning) {
      alert('Please resolve the duplicate client warning first.');
      return;
    }
  ...
  return (
    <Modal
      ...
      title="Entity Onboarding"size="xl">
      <div className="space-y-6">
        ...
        >
          <button
            type="button"onClick={() => setAddForm({ ...addForm, company_type:'Private Joint Stock'})}
            className={`px-6 py-2.5 rounded-lg text-sm font-semibold transition-all ${
              addForm.company_type
                ?'bg-indigo-600 text-white shadow-md': isDark
                ?'text-slate-300 hover:bg-slate-700':'text-slate-600 hover:bg-white'}`}
          >
            🏢 LEGAL
          </button>
          <button
            type="button"onClick={() => setAddForm({ ...addForm, company_type:''})}
            className={`px-6 py-2.5 rounded-lg text-sm font-semibold transition-all ${
              !addForm.company_type
                ?'bg-indigo-600 text-white shadow-md': isDark
                ?'text-slate-300 hover:bg-slate-700':'text-slate-600 hover:bg-white'}`}
        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full rounded-lg border py-2.5 px-3 text-sm focus:outline-none focus:ring-2 ${
                  addErrors.name_en
                    ?'border-rose-300 focus:ring-rose-100': isDark
                    ?'border-slate-700 bg-slate-800 text-slate-100 focus:border-indigo-400 focus:ring-indigo-900':'border-slate-200 bg-white focus:border-indigo-400 focus:ring-indigo-100'}`}
              />
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full rounded-lg border py-2.5 px-3 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-100 ${
                    isDark
                      ?'border-slate-700 bg-slate-800 text-slate-100 focus:border-indigo-400':'border-slate-200 bg-white focus:border-indigo-400'}`}
                />
              </div>
            )}
            ...
            <div>
              ...
              >
                {addForm.company_type
                  ?'National ID (11 digits) *':'National Code (10 digits) *'}
              </label>
              <input
        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                type="email"value={addForm.email_inbox}
                onChange={(e) =>
              ...
              >
                ...
                <span
                  className={`text-xs font-bold px-2 py-1 rounded-full ${
                    isDark
                      ?'bg-indigo-900/50 text-indigo-300':'bg-indigo-100 text-indigo-700'}`}
                >
              ...
              {addForm.contactPersons.map((cp) => (
                <div
                  ...
                  className={`grid grid-cols-12 gap-3 p-4 rounded-xl border ${
                    isDark
                      ?'border-slate-700 bg-slate-800/50':'border-slate-200 bg-slate-50/50'}`}
                >
                  ...
                  <div className="col-span-2 flex items-end gap-1">
                    ...
                    {addForm.contactPersons.length > 1 && (
                      <button
                        type="button"onClick={() => removeContactPerson(cp.id)}
