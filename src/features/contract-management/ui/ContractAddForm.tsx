// src/features/contract-management/ui/ContractAddForm.tsx
...
export function ContractAddForm({
  ...
  const [formData, setFormData] = useState({
    ...
    type: (typeFilter === "WORK_ORDER" ? "WORK_ORDER" : "CONTRACT") as
      | "CONTRACT"
      | "WORK_ORDER",
    contract_count: 1,
    description: "",
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      console.error("[ContractAddForm] Save failed:", err);
      showToast(
        "error",
        "Save Failed",
  ...
  return (
    ...
    >
      <div className="space-y-3">
        {/* ═══════════════════════════════════════ */}
        {/* 🔹 TYPE SELECTOR - UI مدرن با gradient */}
        {/* ═══════════════════════════════════════ */}
        <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setFormData({
                              ...
                              guarantee: {
                                ...formData.guarantee,
                                percentage: parseNumberInput(e.target.value),
                              },
                            })
                          }
                          className="w-full rounded-lg border px-3 py-2 text-sm font-mono text-right input-themed"
                      ...
                      <input
                        ...
                        value={
                          formData.insurance_deduction_percentage
                            ? formatNumberInput(
                                String(formData.insurance_deduction_percentage),
                              )
                            : ""
                        }
                        onChange={(e) =>
